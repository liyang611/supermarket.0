...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${path}/bill/list">订单管理</a></li>
              <li><a href="${path }/provider/sys">供应商管理</a></li>
              <li><a href="${path }/provider/user">用户管理</a></li>
              <li><a href="${path }/provider/pwdmodify">密码修改</a></li>
