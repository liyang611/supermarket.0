...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${path}/bill/list">
			<span>商品名称：</span>
		   ...
		   <input type="hidden" id="totalPageCount" value="${page.pages}"/>
			 ...
			 <a href="${path}/bill/billadd">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList}" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="${path }/bill/billview/${bill.id }"><img src="${path}/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyBill" href="${path }/bill/billmodify?billid=${bill.id }"><img src="${path}/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
